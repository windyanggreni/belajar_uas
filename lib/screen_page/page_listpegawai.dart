...
import 'package:latihan_uasp/screen_page/page_detail.dart';
import 'package:latihan_uasp/screen_page/page_insert.dart';
import 'package:latihan_uasp/screen_page/page_update.dart';
...
class _PageUtamaState extends State<PageUtama> {
  ...
  Future<void> getEmployees() async {
    try {
      var response = await http.get(Uri.parse('http://192.168.43.124/latihanuasp/getPegawai.php'));
  ...
  Future<void> deleteEmployee(String id) async {
    try {
      var response = await http.post(
        Uri.parse('http://192.168.43.124/latihanuasp/deletePegawai.php'),
        body: {'id': id},
      );
      var jsonData = json.decode(response.body);
